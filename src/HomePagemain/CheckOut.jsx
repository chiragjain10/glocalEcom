...
const Checkout = () => {
  ...
  const [cartItems, setCartItems] = useState([
    ...
    },
    {
      ...
      name: "Tribal Mask",
      image:
        "https://cdn.pixabay.com/photo/2017/01/06/19/15/mask-1959324_1280.jpg",
      price: 1299,
    },
  ]);
  ...
  return (
    <div style={{ backgroundColor: '#f9fafb', minHeight: '100vh', paddingTop: '50px' }}>
    <div className="max-w-7xl mx-auto p-6" style={{ marginTop: "50px"}}>
      {/* Cart Header (now on top) */}
      <div className="cart-header mb-6">
        <h1 className="text-3xl font-bold mb-2">Checkout</h1>
        <div className="stepper flex items-center gap-2 text-sm text-gray-600">
          <div className="step text-amber-500 font-semibold text-gray-400">
            <span className="mr-1">1</span> Cart
          </div>
          <FiChevronRight className="" />
          <div className="step active font-semibold text-gray-500">
            <span className="mr-1">2</span> Checkout
          </div>
          <FiChevronRight className="text-gray-400" />
          <div className="step text-gray-500">
            <span className="mr-1">3</span> Payment
          </div>
        </div>
      </div>
