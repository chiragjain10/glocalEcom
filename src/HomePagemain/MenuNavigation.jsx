    ...
    <div className="flex flex-wrap justify-center items-center gap-6 py-4 border-t relative z-50">
      {categories.map((item, index) => (
        <div key={index} className="relative group cursor-pointer">
          {/* Main category */}
          <div className="flex items-center space-x-2 hover:text-orange-600 transition-all">
                ...
                <>
                  ...
                  <div className="py-2 px-4 min-w-[200px]">
                    {hoveredSubItem.subSubItems.map((subSub, idx) => (
                      <div
                        key={idx}
                        className="text-sm text-gray-700 hover:text-orange-600 py-1 px-2 whitespace-nowrap"
                      >
                        {subSub}
                      </div>
                    ))}
