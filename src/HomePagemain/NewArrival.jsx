...
const NewArrival = () => {
  ...
  const newArrivalItems = getNewArrivals();
    ...
    <section className="py-10 px-5 bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto">
                ...
                <div className="relative overflow-hidden">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="bg-white p-2 rounded-full shadow-md hover:bg-amber-50 hover:text-amber-500 transition-all duration-300 transform hover:scale-110"
                      title="Add to cart"
                    >
                      {addingId === item.id ? (
        ...
        <div className="flex justify-center gap-2 mt-5">
          {Array.from({ length: Math.ceil(newArrivalItems.length / visibleCards) }).map(
            (_, index) => (
              <button
                key={index}
